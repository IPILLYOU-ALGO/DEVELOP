...
| - Product Manager <br> - AI(EasyOCR) | - AI(Resnet) <br> -BackEnd(Login, durg-search) <br> -ui/ux & api명세서 작성| - Data preprocessing <br> -AI(LangChain) <br> -BackEnd(Drug-Analyze) | - AI(Yolov8) <br> -BackEnd(Drug-discovery) | - AI(EasyOCR, TesseractOCR) <br> -FrontEnd|
