    ...
    return ( 
        <>
            ...
            <div className="p-5 pt-10 w-full mx-auto">
              <button type="button" className="mx-auto w-full rounded-2xl h-[70px] bg-white text-xl font-bold hover:bg-[#2cc65b] text-gray-400 hover:text-gray-50">로그인</button>
            </div>
            ...
            <Link href="/register">
              <button class="text-blue-600 border p-1 rounded-md">회원가입</button>
            </Link>
            </div>
